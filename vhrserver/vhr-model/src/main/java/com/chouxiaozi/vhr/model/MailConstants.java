...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "employeeQueue";
    public static final String MAIL_EXCHANGE_NAME = "employeeExchange";
    public static final String MAIL_ROUTING_KEY_NAME = "addEmployee";
}
